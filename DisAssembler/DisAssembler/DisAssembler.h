...
public:
	...
	DisAssembler()
	{
		bankselhelp = 0; 
/*
		ifstream reg("registers.txt");

		for (int i = 0; i < 512; ++i)
		{
			getline(reg, registers[i]); 
		}
...
/*	string getReg(string code)
	{
		return registers[hxStrConv(code)];
	}*/
